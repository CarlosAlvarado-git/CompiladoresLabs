...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Oct 06 16:10:40 CST 2022
  */
public class Sintax extends java_cup.runtime.lr_parser {
  ...
  public int error_sym() {return 1;}
    ...
    public void syntax_error(Symbol s){
        //this.s = s;
        System.out.println("Error Sintactico en la Linea " + (s.right+1) +" Columna: " +(s.left)+ ". Identificador " +s.value + " no reconocido." + "el type: " + s.type);
    }
